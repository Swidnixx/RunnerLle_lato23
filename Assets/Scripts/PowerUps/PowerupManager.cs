...
public class PowerupManager : ScriptableObject
{
    ...
    private void Awake()
    {
        ...
        ImmortalitySO tmp = Resources.Load<ImmortalitySO>("Data/" + PlayerPrefs.GetString("BatteryLevel"));
        if (tmp != null)
        {
            _battery = tmp;
        ...
        MagnetSO tmp2 = Resources.Load<MagnetSO>("Data/" + PlayerPrefs.GetString("MagnetLevel"));
        if (tmp2 != null)
        {
            _magnet = tmp2;
